...
public class listaClientesController implements Initializable{
	 ...
	 @FXML
		...
		void OnClickEditar(ActionEvent event) {
			Clientes cliente = this.tbvClientes.getSelectionModel().getSelectedItem();
		...
		public void initialize(URL location, ResourceBundle resources) {
			...
			this.tbvClientes.getSelectionModel().selectedItemProperty()
					.addListener((observable, oldValue, newValue) -> selecionarItemTableViewClientes((Clientes) newValue));
		}
		...
		public boolean onShowTelaClientesEditar(Clientes Clientes, String operacao) {
			try {
				...
				editClientes.setJanelaClientesEdit(janelaClientesEditar);
